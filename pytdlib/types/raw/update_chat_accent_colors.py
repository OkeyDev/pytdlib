...
class UpdateChatAccentColors(Update):
    ...
    def __init__(self, chat_id = None, accent_color_id = None, background_custom_emoji_id = None, profile_accent_color_id = None, profile_background_custom_emoji_id = None):
