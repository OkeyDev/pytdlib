...
class ChatInviteLinkInfo(ObjectBase):
    ...
    def __init__(self, chat_id = None, accessible_for = None, type = None, title = None, photo = None, accent_color_id = None, description = None, member_count = None, member_user_ids = None, subscription_info = None, creates_join_request = None, is_public = None, verification_status = None):
