...
class LinkPreview(ObjectBase):
    ...
    def __init__(self, url = None, display_url = None, site_name = None, title = None, description = None, author = None, type = None, has_large_media = None, show_large_media = None, show_media_above_description = None, skip_confirmation = None, show_above_text = None, instant_view_version = None):
        self.url = url
