...
class MessageGiftedStars(MessageContent):
    ...
    def __init__(self, gifter_user_id: int = 0, receiver_user_id: int = 0, currency: str = "", amount: int = 0, cryptocurrency: str = "", cryptocurrency_amount: int = 0, star_count: int = 0, transaction_id: str = "", sticker: Sticker | None = None):
