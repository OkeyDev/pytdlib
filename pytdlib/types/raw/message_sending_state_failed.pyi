...
class MessageSendingStateFailed(MessageSendingState):
    ...
    def __init__(self, error: Error | None = None, can_retry: bool = False, need_another_sender: bool = False, need_another_reply_quote: bool = False, need_drop_reply: bool = False, required_paid_message_star_count: int = 0, retry_after: float = 0):
        self.error = error
