...
class InputMessageAnimation(InputMessageContent):
    ...
    def __init__(self, animation: InputFile | None = None, thumbnail: InputThumbnail | None = None, added_sticker_file_ids: List[int] | None = None, duration: int = 0, width: int = 0, height: int = 0, caption: FormattedText | None = None, show_caption_above_media: bool = False, has_spoiler: bool = False):
