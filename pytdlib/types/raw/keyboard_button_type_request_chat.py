...
class KeyboardButtonTypeRequestChat(KeyboardButtonType):
    ...
    def __init__(self, id = None, chat_is_channel = None, restrict_chat_is_forum = None, chat_is_forum = None, restrict_chat_has_username = None, chat_has_username = None, chat_is_created = None, user_administrator_rights = None, bot_administrator_rights = None, bot_is_member = None, request_title = None, request_username = None, request_photo = None):
        self.id = id
