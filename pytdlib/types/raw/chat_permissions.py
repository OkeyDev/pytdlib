...
class ChatPermissions(ObjectBase):
    ...
    def __init__(self, can_send_basic_messages = None, can_send_audios = None, can_send_documents = None, can_send_photos = None, can_send_videos = None, can_send_video_notes = None, can_send_voice_notes = None, can_send_polls = None, can_send_other_messages = None, can_add_link_previews = None, can_change_info = None, can_invite_users = None, can_pin_messages = None, can_create_topics = None):
