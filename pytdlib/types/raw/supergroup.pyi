...
class Supergroup(ObjectBase):
    ...
    def __init__(self, id: int = 0, usernames: Usernames | None = None, date: int = 0, status: ChatMemberStatus | None = None, member_count: int = 0, boost_level: int = 0, has_automatic_translation: bool = False, has_linked_chat: bool = False, has_location: bool = False, sign_messages: bool = False, show_message_sender: bool = False, join_to_send_messages: bool = False, join_by_request: bool = False, is_slow_mode_enabled: bool = False, is_channel: bool = False, is_broadcast_group: bool = False, is_forum: bool = False, is_direct_messages_group: bool = False, is_administered_direct_messages_group: bool = False, verification_status: VerificationStatus | None = None, has_direct_messages_group: bool = False, has_forum_tabs: bool = False, has_sensitive_content: bool = False, restriction_reason: str = "", paid_message_star_count: int = 0, has_active_stories: bool = False, has_unread_active_stories: bool = False):
        self.id = id
