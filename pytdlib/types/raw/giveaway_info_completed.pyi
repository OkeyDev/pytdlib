...
class GiveawayInfoCompleted(GiveawayInfo):
    ...
    def __init__(self, creation_date: int = 0, actual_winners_selection_date: int = 0, was_refunded: bool = False, is_winner: bool = False, winner_count: int = 0, activation_count: int = 0, gift_code: str = "", won_star_count: int = 0):
