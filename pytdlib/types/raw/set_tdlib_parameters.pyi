...
class SetTdlibParameters(Function[Ok]):
    ...
    def __init__(self, use_test_dc: bool = False, database_directory: str = "", files_directory: str = "", database_encryption_key: bytes = b"", use_file_database: bool = False, use_chat_info_database: bool = False, use_message_database: bool = False, use_secret_chats: bool = False, api_id: int = 0, api_hash: str = "", system_language_code: str = "", device_model: str = "", system_version: str = "", application_version: str = ""):
