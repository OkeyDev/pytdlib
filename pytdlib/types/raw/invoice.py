...
class Invoice(ObjectBase):
    ...
    def __init__(self, currency = None, price_parts = None, subscription_period = None, max_tip_amount = None, suggested_tip_amounts = None, recurring_payment_terms_of_service_url = None, terms_of_service_url = None, is_test = None, need_name = None, need_phone_number = None, need_email_address = None, need_shipping_address = None, send_phone_number_to_provider = None, send_email_address_to_provider = None, is_flexible = None):
