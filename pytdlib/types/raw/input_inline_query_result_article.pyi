...
class InputInlineQueryResultArticle(InputInlineQueryResult):
    ...
    """
    __slots__ = ("id", "url", "title", "description", "thumbnail_url", "thumbnail_width", "thumbnail_height", "reply_markup", "input_message_content", "_extra", "_client_id", "_type")

    def __init__(self, id: str = "", url: str = "", title: str = "", description: str = "", thumbnail_url: str = "", thumbnail_width: int = 0, thumbnail_height: int = 0, reply_markup: ReplyMarkup | None = None, input_message_content: InputMessageContent | None = None):
        self.id = id
        self.url = url
        self.title = title
        ...
        self._type = "inputInlineQueryResultArticle"