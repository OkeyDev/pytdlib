...
class KeyboardButtonTypeRequestUsers(KeyboardButtonType):
    ...
    def __init__(self, id = None, restrict_user_is_bot = None, user_is_bot = None, restrict_user_is_premium = None, user_is_premium = None, max_quantity = None, request_name = None, request_username = None, request_photo = None):
        self.id = id
