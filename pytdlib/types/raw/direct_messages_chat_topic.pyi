...
class DirectMessagesChatTopic(ObjectBase):
    ...
    def __init__(self, chat_id: int = 0, id: int = 0, sender_id: MessageSender | None = None, order: int = 0, is_marked_as_unread: bool = False, unread_count: int = 0, last_read_inbox_message_id: int = 0, last_read_outbox_message_id: int = 0, unread_reaction_count: int = 0, last_message: Message | None = None, draft_message: DraftMessage | None = None):
