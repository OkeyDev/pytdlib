...
class InputInlineQueryResultDocument(InputInlineQueryResult):
    ...
    def __init__(self, id: str = "", title: str = "", description: str = "", document_url: str = "", mime_type: str = "", thumbnail_url: str = "", thumbnail_width: int = 0, thumbnail_height: int = 0, reply_markup: ReplyMarkup | None = None, input_message_content: InputMessageContent | None = None):
        self.id = id
        self.title = title
