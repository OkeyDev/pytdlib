...
class Gift(ObjectBase):
    ...
    def __init__(self, id = None, sticker = None, star_count = None, default_sell_star_count = None, upgrade_star_count = None, is_for_birthday = None, remaining_count = None, total_count = None, first_send_date = None, last_send_date = None):
        self.id = id
