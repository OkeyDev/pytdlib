...
class OpenWebApp(Function[WebAppInfo]):
    ...
    def __init__(self, chat_id: int = 0, bot_user_id: int = 0, url: str = "", message_thread_id: int = 0, direct_messages_chat_topic_id: int = 0, reply_to: InputMessageReplyTo | None = None, parameters: WebAppOpenParameters | None = None):
