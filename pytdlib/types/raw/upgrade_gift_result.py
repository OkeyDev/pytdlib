...
class UpgradeGiftResult(ObjectBase):
    ...
    def __init__(self, gift = None, received_gift_id = None, is_saved = None, can_be_transferred = None, transfer_star_count = None, next_transfer_date = None, next_resale_date = None, export_date = None):
        self.gift = gift
