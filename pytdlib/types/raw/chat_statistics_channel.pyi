...
class ChatStatisticsChannel(ChatStatistics):
    ...
    def __init__(self, period: DateRange | None = None, member_count: StatisticalValue | None = None, mean_message_view_count: StatisticalValue | None = None, mean_message_share_count: StatisticalValue | None = None, mean_message_reaction_count: StatisticalValue | None = None, mean_story_view_count: StatisticalValue | None = None, mean_story_share_count: StatisticalValue | None = None, mean_story_reaction_count: StatisticalValue | None = None, enabled_notifications_percentage: float = 0, member_count_graph: StatisticalGraph | None = None, join_graph: StatisticalGraph | None = None, mute_graph: StatisticalGraph | None = None, view_count_by_hour_graph: StatisticalGraph | None = None, view_count_by_source_graph: StatisticalGraph | None = None, join_by_source_graph: StatisticalGraph | None = None, language_graph: StatisticalGraph | None = None, message_interaction_graph: StatisticalGraph | None = None, message_reaction_graph: StatisticalGraph | None = None, story_interaction_graph: StatisticalGraph | None = None, story_reaction_graph: StatisticalGraph | None = None, instant_view_interaction_graph: StatisticalGraph | None = None, recent_interactions: List[ChatStatisticsInteractionInfo] | None = None):
        self.period = period
