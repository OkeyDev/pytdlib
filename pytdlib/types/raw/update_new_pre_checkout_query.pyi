...
class UpdateNewPreCheckoutQuery(Update):
    ...
    def __init__(self, id: int = 0, sender_user_id: int = 0, currency: str = "", total_amount: int = 0, invoice_payload: bytes = b"", shipping_option_id: str = "", order_info: OrderInfo | None = None):
        self.id = id
