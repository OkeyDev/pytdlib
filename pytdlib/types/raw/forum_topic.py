...
class ForumTopic(ObjectBase):
    ...
    def __init__(self, info = None, last_message = None, order = None, is_pinned = None, unread_count = None, last_read_inbox_message_id = None, last_read_outbox_message_id = None, unread_mention_count = None, unread_reaction_count = None, notification_settings = None, draft_message = None):
        self.info = info
