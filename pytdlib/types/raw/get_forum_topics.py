...
class GetForumTopics(Function):
    ...
    def __init__(self, chat_id = None, query = None, offset_date = None, offset_message_id = None, offset_message_thread_id = None, limit = None):
