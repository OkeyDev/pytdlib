...
class ChatAdministratorRights(ObjectBase):
    ...
    def __init__(self, can_manage_chat = None, can_change_info = None, can_post_messages = None, can_edit_messages = None, can_delete_messages = None, can_invite_users = None, can_restrict_members = None, can_pin_messages = None, can_manage_topics = None, can_promote_members = None, can_manage_video_chats = None, can_post_stories = None, can_edit_stories = None, can_delete_stories = None, is_anonymous = None):
