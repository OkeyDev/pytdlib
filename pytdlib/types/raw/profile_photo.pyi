...
class ProfilePhoto(ObjectBase):
    ...
    def __init__(self, id: int = 0, small: File | None = None, big: File | None = None, minithumbnail: Minithumbnail | None = None, has_animation: bool = False, is_personal: bool = False):
        self.id = id
        self.small = small
        self.big = big
