...
class InputInlineQueryResultPhoto(InputInlineQueryResult):
    ...
    def __init__(self, id: str = "", title: str = "", description: str = "", thumbnail_url: str = "", photo_url: str = "", photo_width: int = 0, photo_height: int = 0, reply_markup: ReplyMarkup | None = None, input_message_content: InputMessageContent | None = None):
        self.id = id
        self.title = title
