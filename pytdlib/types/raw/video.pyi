...
class Video(ObjectBase):
    ...
    def __init__(self, duration: int = 0, width: int = 0, height: int = 0, file_name: str = "", mime_type: str = "", has_stickers: bool = False, supports_streaming: bool = False, minithumbnail: Minithumbnail | None = None, thumbnail: Thumbnail | None = None, video: File | None = None):
