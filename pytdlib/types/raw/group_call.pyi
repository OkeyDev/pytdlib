...
class GroupCall(ObjectBase):
    ...
    def __init__(self, id: int = 0, title: str = "", invite_link: str = "", scheduled_start_date: int = 0, enabled_start_notification: bool = False, is_active: bool = False, is_video_chat: bool = False, is_rtmp_stream: bool = False, is_joined: bool = False, need_rejoin: bool = False, is_owned: bool = False, can_be_managed: bool = False, participant_count: int = 0, has_hidden_listeners: bool = False, loaded_all_participants: bool = False, recent_speakers: List[GroupCallRecentSpeaker] | None = None, is_my_video_enabled: bool = False, is_my_video_paused: bool = False, can_enable_video: bool = False, mute_new_participants: bool = False, can_toggle_mute_new_participants: bool = False, record_duration: int = 0, is_video_recorded: bool = False, duration: int = 0):
        self.id = id
        self.title = title
