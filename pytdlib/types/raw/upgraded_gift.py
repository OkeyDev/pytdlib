...
class UpgradedGift(ObjectBase):
    ...
    def __init__(self, id = None, title = None, name = None, number = None, total_upgraded_count = None, max_upgraded_count = None, owner_id = None, owner_address = None, owner_name = None, gift_address = None, model = None, symbol = None, backdrop = None, original_details = None, resale_star_count = None):
        self.id = id
        self.title = title
        self.name = name
        self.number = number
