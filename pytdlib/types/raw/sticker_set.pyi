...
class StickerSet(ObjectBase):
    ...
    def __init__(self, id: int = 0, title: str = "", name: str = "", thumbnail: Thumbnail | None = None, thumbnail_outline: Outline | None = None, is_owned: bool = False, is_installed: bool = False, is_archived: bool = False, is_official: bool = False, sticker_type: StickerType | None = None, needs_repainting: bool = False, is_allowed_as_chat_emoji_status: bool = False, is_viewed: bool = False, stickers: List[Sticker] | None = None, emojis: List[Emojis] | None = None):
        self.id = id
        self.title = title
        self.name = name
