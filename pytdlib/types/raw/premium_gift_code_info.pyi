...
class PremiumGiftCodeInfo(ObjectBase):
    ...
    def __init__(self, creator_id: MessageSender | None = None, creation_date: int = 0, is_from_giveaway: bool = False, giveaway_message_id: int = 0, month_count: int = 0, user_id: int = 0, use_date: int = 0):
