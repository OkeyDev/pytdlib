...
class User(ObjectBase):
    ...
    def __init__(self, id: int = 0, first_name: str = "", last_name: str = "", usernames: Usernames | None = None, phone_number: str = "", status: UserStatus | None = None, profile_photo: ProfilePhoto | None = None, accent_color_id: int = 0, background_custom_emoji_id: int = 0, profile_accent_color_id: int = 0, profile_background_custom_emoji_id: int = 0, emoji_status: EmojiStatus | None = None, is_contact: bool = False, is_mutual_contact: bool = False, is_close_friend: bool = False, verification_status: VerificationStatus | None = None, is_premium: bool = False, is_support: bool = False, restriction_reason: str = "", has_active_stories: bool = False, has_unread_active_stories: bool = False, restricts_new_chats: bool = False, paid_message_star_count: int = 0, have_access: bool = False, type: UserType | None = None, language_code: str = "", added_to_attachment_menu: bool = False):
        self.id = id
