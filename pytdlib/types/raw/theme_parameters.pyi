...
class ThemeParameters(ObjectBase):
    ...
    def __init__(self, background_color: int = 0, secondary_background_color: int = 0, header_background_color: int = 0, bottom_bar_background_color: int = 0, section_background_color: int = 0, section_separator_color: int = 0, text_color: int = 0, accent_text_color: int = 0, section_header_text_color: int = 0, subtitle_text_color: int = 0, destructive_text_color: int = 0, hint_color: int = 0, link_color: int = 0, button_color: int = 0, button_text_color: int = 0):
