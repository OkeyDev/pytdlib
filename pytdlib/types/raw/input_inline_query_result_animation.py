...
class InputInlineQueryResultAnimation(InputInlineQueryResult):
    ...
    def __init__(self, id = None, title = None, thumbnail_url = None, thumbnail_mime_type = None, video_url = None, video_mime_type = None, video_duration = None, video_width = None, video_height = None, reply_markup = None, input_message_content = None):
        self.id = id
        self.title = title
