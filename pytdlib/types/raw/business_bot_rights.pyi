...
class BusinessBotRights(ObjectBase):
    ...
    def __init__(self, can_reply: bool = False, can_read_messages: bool = False, can_delete_sent_messages: bool = False, can_delete_all_messages: bool = False, can_edit_name: bool = False, can_edit_bio: bool = False, can_edit_profile_photo: bool = False, can_edit_username: bool = False, can_view_gifts_and_stars: bool = False, can_sell_gifts: bool = False, can_change_gift_settings: bool = False, can_transfer_and_upgrade_gifts: bool = False, can_transfer_stars: bool = False, can_manage_stories: bool = False):
