...
class GetChatInviteLinks(Function):
    """
    ...
    def __init__(self, chat_id = None, creator_user_id = None, is_revoked = None, offset_date = None, offset_invite_link = None, limit = None):
