...
class ForumTopicInfo(ObjectBase):
    ...
    def __init__(self, chat_id = None, forum_topic_id = None, message_thread_id = None, name = None, icon = None, creation_date = None, creator_id = None, is_general = None, is_outgoing = None, is_closed = None, is_hidden = None):
