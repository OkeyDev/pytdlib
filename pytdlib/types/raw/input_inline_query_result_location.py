...
class InputInlineQueryResultLocation(InputInlineQueryResult):
    ...
    def __init__(self, id = None, location = None, live_period = None, title = None, thumbnail_url = None, thumbnail_width = None, thumbnail_height = None, reply_markup = None, input_message_content = None):
        self.id = id
