...
class PremiumGiftPaymentOption(ObjectBase):
    ...
    def __init__(self, currency: str = "", amount: int = 0, star_count: int = 0, discount_percentage: int = 0, month_count: int = 0, store_product_id: str = "", sticker: Sticker | None = None):
