...
class InputInlineQueryResultArticle(InputInlineQueryResult):
    ...
    def __init__(self, id = None, url = None, title = None, description = None, thumbnail_url = None, thumbnail_width = None, thumbnail_height = None, reply_markup = None, input_message_content = None):
        self.id = id
        self.url = url
        self.title = title
