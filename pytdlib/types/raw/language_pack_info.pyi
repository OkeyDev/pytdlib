...
class LanguagePackInfo(ObjectBase):
    ...
    def __init__(self, id: str = "", base_language_pack_id: str = "", name: str = "", native_name: str = "", plural_code: str = "", is_official: bool = False, is_rtl: bool = False, is_beta: bool = False, is_installed: bool = False, total_string_count: int = 0, translated_string_count: int = 0, local_string_count: int = 0, translation_url: str = ""):
        self.id = id
