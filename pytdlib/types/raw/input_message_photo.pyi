...
class InputMessagePhoto(InputMessageContent):
    ...
    def __init__(self, photo: InputFile | None = None, thumbnail: InputThumbnail | None = None, added_sticker_file_ids: List[int] | None = None, width: int = 0, height: int = 0, caption: FormattedText | None = None, show_caption_above_media: bool = False, self_destruct_type: MessageSelfDestructType | None = None, has_spoiler: bool = False):
        self.photo = photo
