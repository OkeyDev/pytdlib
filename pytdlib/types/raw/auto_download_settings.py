...
class AutoDownloadSettings(ObjectBase):
    ...
    def __init__(self, is_auto_download_enabled = None, max_photo_file_size = None, max_video_file_size = None, max_other_file_size = None, video_upload_bitrate = None, preload_large_videos = None, preload_next_audio = None, preload_stories = None, use_less_data_for_calls = None):
