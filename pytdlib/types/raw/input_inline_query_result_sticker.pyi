...
class InputInlineQueryResultSticker(InputInlineQueryResult):
    ...
    def __init__(self, id: str = "", thumbnail_url: str = "", sticker_url: str = "", sticker_width: int = 0, sticker_height: int = 0, reply_markup: ReplyMarkup | None = None, input_message_content: InputMessageContent | None = None):
        self.id = id
