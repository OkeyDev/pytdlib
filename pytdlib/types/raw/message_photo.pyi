...
class MessagePhoto(MessageContent):
    ...
    def __init__(self, photo: Photo | None = None, caption: FormattedText | None = None, show_caption_above_media: bool = False, has_spoiler: bool = False, is_secret: bool = False):
        self.photo = photo
