...
class MessageSendOptions(ObjectBase):
    ...
    def __init__(self, direct_messages_chat_topic_id = None, disable_notification = None, from_background = None, protect_content = None, allow_paid_broadcast = None, paid_message_star_count = None, update_order_of_installed_sticker_sets = None, scheduling_state = None, effect_id = None, sending_id = None, only_preview = None):
