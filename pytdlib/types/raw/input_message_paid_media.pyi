...
class InputMessagePaidMedia(InputMessageContent):
    ...
    def __init__(self, star_count: int = 0, paid_media: List[InputPaidMedia] | None = None, caption: FormattedText | None = None, show_caption_above_media: bool = False, payload: str = ""):
