...
class StickerSet(ObjectBase):
    ...
    """
    __slots__ = ("id", "title", "name", "thumbnail", "thumbnail_outline", "is_owned", "is_installed", "is_archived", "is_official", "sticker_type", "needs_repainting", "is_allowed_as_chat_emoji_status", "is_viewed", "stickers", "emojis", "_extra", "_client_id", "_type")

    def __init__(self, id = None, title = None, name = None, thumbnail = None, thumbnail_outline = None, is_owned = None, is_installed = None, is_archived = None, is_official = None, sticker_type = None, needs_repainting = None, is_allowed_as_chat_emoji_status = None, is_viewed = None, stickers = None, emojis = None):
        self.id = id
        self.title = title
        self.name = name
