...
class InputMessagePoll(InputMessageContent):
    ...
    def __init__(self, question: FormattedText | None = None, options: List[FormattedText] | None = None, is_anonymous: bool = False, type: PollType | None = None, open_period: int = 0, close_date: int = 0, is_closed: bool = False):
