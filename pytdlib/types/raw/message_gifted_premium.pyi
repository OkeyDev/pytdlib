...
class MessageGiftedPremium(MessageContent):
    ...
    def __init__(self, gifter_user_id: int = 0, receiver_user_id: int = 0, text: FormattedText | None = None, currency: str = "", amount: int = 0, cryptocurrency: str = "", cryptocurrency_amount: int = 0, month_count: int = 0, sticker: Sticker | None = None):
