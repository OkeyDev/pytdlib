...
class QuickReplyMessage(ObjectBase):
    ...
    def __init__(self, id = None, sending_state = None, can_be_edited = None, reply_to_message_id = None, via_bot_user_id = None, media_album_id = None, content = None, reply_markup = None):
        self.id = id
