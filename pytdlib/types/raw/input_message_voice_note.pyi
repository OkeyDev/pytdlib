...
class InputMessageVoiceNote(InputMessageContent):
    ...
    def __init__(self, voice_note: InputFile | None = None, duration: int = 0, waveform: bytes = b"", caption: FormattedText | None = None, self_destruct_type: MessageSelfDestructType | None = None):
