...
class PostStory(Function):
    ...
    def __init__(self, chat_id = None, content = None, areas = None, caption = None, privacy_settings = None, active_period = None, from_story_full_id = None, is_posted_to_chat_page = None, protect_content = None):
