...
class UpdateChatMember(Update):
    ...
    def __init__(self, chat_id = None, actor_user_id = None, date = None, invite_link = None, via_join_request = None, via_chat_folder_invite_link = None, old_chat_member = None, new_chat_member = None):
