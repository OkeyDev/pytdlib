...
class SponsoredMessage(ObjectBase):
    ...
    def __init__(self, message_id = None, is_recommended = None, can_be_reported = None, content = None, sponsor = None, title = None, button_text = None, accent_color_id = None, background_custom_emoji_id = None, additional_info = None):
