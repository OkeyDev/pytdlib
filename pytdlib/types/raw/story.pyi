...
class Story(ObjectBase):
    ...
    def __init__(self, id: int = 0, poster_chat_id: int = 0, poster_id: MessageSender | None = None, date: int = 0, is_being_posted: bool = False, is_being_edited: bool = False, is_edited: bool = False, is_posted_to_chat_page: bool = False, is_visible_only_for_self: bool = False, can_be_deleted: bool = False, can_be_edited: bool = False, can_be_forwarded: bool = False, can_be_replied: bool = False, can_toggle_is_posted_to_chat_page: bool = False, can_get_statistics: bool = False, can_get_interactions: bool = False, has_expired_viewers: bool = False, repost_info: StoryRepostInfo | None = None, interaction_info: StoryInteractionInfo | None = None, chosen_reaction_type: ReactionType | None = None, privacy_settings: StoryPrivacySettings | None = None, content: StoryContent | None = None, areas: List[StoryArea] | None = None, caption: FormattedText | None = None):
        self.id = id
