...
class EditBusinessMessageMedia(Function[BusinessMessage]):
    ...
    def __init__(self, business_connection_id: str = "", chat_id: int = 0, message_id: int = 0, reply_markup: ReplyMarkup | None = None, input_message_content: InputMessageContent | None = None):
        self.business_connection_id = business_connection_id
        self.chat_id = chat_id
        self.message_id = message_id
        self.reply_markup = reply_markup
        self.input_message_content = input_message_content
        self._type = "editBusinessMessageMedia"