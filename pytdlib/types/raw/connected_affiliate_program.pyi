...
class ConnectedAffiliateProgram(ObjectBase):
    ...
    def __init__(self, url: str = "", bot_user_id: int = 0, parameters: AffiliateProgramParameters | None = None, connection_date: int = 0, is_disconnected: bool = False, user_count: int = 0, revenue_star_count: int = 0):
        self.url = url
