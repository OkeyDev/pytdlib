...
class AccountInfo(ObjectBase):
    ...
    def __init__(self, registration_month = None, registration_year = None, phone_number_country_code = None, last_name_change_date = None, last_photo_change_date = None):
