...
class AddQuickReplyShortcutInlineQueryResultMessage(Function):
    """
    ...
    def __init__(self, shortcut_name = None, reply_to_message_id = None, query_id = None, result_id = None, hide_via_bot = None):
