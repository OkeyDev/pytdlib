...
class UserFullInfo(ObjectBase):
    ...
    def __init__(self, personal_photo: ChatPhoto | None = None, photo: ChatPhoto | None = None, public_photo: ChatPhoto | None = None, block_list: BlockList | None = None, can_be_called: bool = False, supports_video_calls: bool = False, has_private_calls: bool = False, has_private_forwards: bool = False, has_restricted_voice_and_video_note_messages: bool = False, has_posted_to_profile_stories: bool = False, has_sponsored_messages_enabled: bool = False, need_phone_number_privacy_exception: bool = False, set_chat_background: bool = False, bio: FormattedText | None = None, birthdate: Birthdate | None = None, personal_chat_id: int = 0, gift_count: int = 0, group_in_common_count: int = 0, incoming_paid_message_star_count: int = 0, outgoing_paid_message_star_count: int = 0, gift_settings: GiftSettings | None = None, bot_verification: BotVerification | None = None, business_info: BusinessInfo | None = None, bot_info: BotInfo | None = None):
