...
class Message(ObjectBase):
    ...
    def __init__(self, id: int = 0, sender_id: MessageSender | None = None, chat_id: int = 0, sending_state: MessageSendingState | None = None, scheduling_state: MessageSchedulingState | None = None, is_outgoing: bool = False, is_pinned: bool = False, is_from_offline: bool = False, can_be_saved: bool = False, has_timestamped_media: bool = False, is_channel_post: bool = False, contains_unread_mention: bool = False, date: int = 0, edit_date: int = 0, forward_info: MessageForwardInfo | None = None, import_info: MessageImportInfo | None = None, interaction_info: MessageInteractionInfo | None = None, unread_reactions: List[UnreadReaction] | None = None, fact_check: FactCheck | None = None, reply_to: MessageReplyTo | None = None, message_thread_id: int = 0, topic_id: MessageTopic | None = None, self_destruct_type: MessageSelfDestructType | None = None, self_destruct_in: float = 0, auto_delete_in: float = 0, via_bot_user_id: int = 0, sender_business_bot_user_id: int = 0, sender_boost_count: int = 0, paid_message_star_count: int = 0, author_signature: str = "", media_album_id: int = 0, effect_id: int = 0, has_sensitive_content: bool = False, restriction_reason: str = "", content: MessageContent | None = None, reply_markup: ReplyMarkup | None = None):
        self.id = id
