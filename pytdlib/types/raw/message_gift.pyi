...
class MessageGift(MessageContent):
    ...
    def __init__(self, gift: Gift | None = None, sender_id: MessageSender | None = None, receiver_id: MessageSender | None = None, received_gift_id: str = "", text: FormattedText | None = None, sell_star_count: int = 0, prepaid_upgrade_star_count: int = 0, is_private: bool = False, is_saved: bool = False, can_be_upgraded: bool = False, was_converted: bool = False, was_upgraded: bool = False, was_refunded: bool = False, upgraded_received_gift_id: str = ""):
        self.gift = gift
