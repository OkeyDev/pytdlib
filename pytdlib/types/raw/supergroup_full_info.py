...
class SupergroupFullInfo(ObjectBase):
    ...
    def __init__(self, photo = None, description = None, member_count = None, administrator_count = None, restricted_count = None, banned_count = None, linked_chat_id = None, direct_messages_chat_id = None, slow_mode_delay = None, slow_mode_delay_expires_in = None, can_enable_paid_messages = None, can_enable_paid_reaction = None, can_get_members = None, has_hidden_members = None, can_hide_members = None, can_set_sticker_set = None, can_set_location = None, can_get_statistics = None, can_get_revenue_statistics = None, can_get_star_revenue_statistics = None, can_send_gift = None, can_toggle_aggressive_anti_spam = None, is_all_history_available = None, can_have_sponsored_messages = None, has_aggressive_anti_spam_enabled = None, has_paid_media_allowed = None, has_pinned_stories = None, gift_count = None, my_boost_count = None, unrestrict_boost_count = None, sticker_set_id = None, custom_emoji_sticker_set_id = None, location = None, invite_link = None, bot_commands = None, bot_verification = None, upgraded_from_basic_group_id = None, upgraded_from_max_message_id = None):
        self.photo = photo
