...
class CallStateReady(CallState):
    ...
    def __init__(self, protocol = None, servers = None, config = None, encryption_key = None, emojis = None, allow_p2p = None, is_group_call_supported = None, custom_parameters = None):
