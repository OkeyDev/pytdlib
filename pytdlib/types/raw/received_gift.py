...
class ReceivedGift(ObjectBase):
    ...
    def __init__(self, received_gift_id = None, sender_id = None, text = None, is_private = None, is_saved = None, is_pinned = None, can_be_upgraded = None, can_be_transferred = None, was_refunded = None, date = None, gift = None, sell_star_count = None, prepaid_upgrade_star_count = None, transfer_star_count = None, next_transfer_date = None, next_resale_date = None, export_date = None):
