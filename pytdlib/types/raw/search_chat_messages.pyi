...
class SearchChatMessages(Function[FoundChatMessages]):
    ...
    def __init__(self, chat_id: int = 0, topic_id: MessageTopic | None = None, query: str = "", sender_id: MessageSender | None = None, from_message_id: int = 0, offset: int = 0, limit: int = 0, filter: SearchMessagesFilter | None = None):
