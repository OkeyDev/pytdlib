...
class GroupCallParticipant(ObjectBase):
    ...
    def __init__(self, participant_id = None, audio_source_id = None, screen_sharing_audio_source_id = None, video_info = None, screen_sharing_video_info = None, bio = None, is_current_user = None, is_speaking = None, is_hand_raised = None, can_be_muted_for_all_users = None, can_be_unmuted_for_all_users = None, can_be_muted_for_current_user = None, can_be_unmuted_for_current_user = None, is_muted_for_all_users = None, is_muted_for_current_user = None, can_unmute_self = None, volume_level = None, order = None):
