...
class PersonalDetails(ObjectBase):
    ...
    def __init__(self, first_name = None, middle_name = None, last_name = None, native_first_name = None, native_middle_name = None, native_last_name = None, birthdate = None, gender = None, country_code = None, residence_country_code = None):
