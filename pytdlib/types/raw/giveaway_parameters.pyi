...
class GiveawayParameters(ObjectBase):
    ...
    def __init__(self, boosted_chat_id: int = 0, additional_chat_ids: List[int] | None = None, winners_selection_date: int = 0, only_new_members: bool = False, has_public_winners: bool = False, country_codes: List[str] | None = None, prize_description: str = ""):
