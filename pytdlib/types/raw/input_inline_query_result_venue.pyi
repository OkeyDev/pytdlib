...
class InputInlineQueryResultVenue(InputInlineQueryResult):
    ...
    """
    __slots__ = ("id", "venue", "thumbnail_url", "thumbnail_width", "thumbnail_height", "reply_markup", "input_message_content", "_extra", "_client_id", "_type")

    def __init__(self, id: str = "", venue: Venue | None = None, thumbnail_url: str = "", thumbnail_width: int = 0, thumbnail_height: int = 0, reply_markup: ReplyMarkup | None = None, input_message_content: InputMessageContent | None = None):
        self.id = id
        self.venue = venue
        ...
        self._type = "inputInlineQueryResultVenue"