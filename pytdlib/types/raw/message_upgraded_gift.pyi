...
class MessageUpgradedGift(MessageContent):
    ...
    def __init__(self, gift: UpgradedGift | None = None, sender_id: MessageSender | None = None, receiver_id: MessageSender | None = None, received_gift_id: str = "", is_upgrade: bool = False, is_saved: bool = False, can_be_transferred: bool = False, was_transferred: bool = False, last_resale_star_count: int = 0, transfer_star_count: int = 0, next_transfer_date: int = 0, next_resale_date: int = 0, export_date: int = 0):
        self.gift = gift
