...
class PhoneNumberAuthenticationSettings(ObjectBase):
    ...
    def __init__(self, allow_flash_call: bool = False, allow_missed_call: bool = False, is_current_phone_number: bool = False, has_unknown_phone_number: bool = False, allow_sms_retriever_api: bool = False, firebase_authentication_settings: FirebaseAuthenticationSettings | None = None, authentication_tokens: List[str] | None = None):
