...
class MessageThreadInfo(ObjectBase):
    ...
    def __init__(self, chat_id: int = 0, message_thread_id: int = 0, reply_info: MessageReplyInfo | None = None, unread_message_count: int = 0, messages: List[Message] | None = None, draft_message: DraftMessage | None = None):
