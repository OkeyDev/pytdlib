...
class ConnectedWebsite(ObjectBase):
    ...
    def __init__(self, id: int = 0, domain_name: str = "", bot_user_id: int = 0, browser: str = "", platform: str = "", log_in_date: int = 0, last_active_date: int = 0, ip_address: str = "", location: str = ""):
        self.id = id
